...
export interface AaveV3AddressesProviderInterface extends utils.Interface {
  functions: {
...
export interface AaveV3AddressesProvider extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AaveV3AddressesProviderInterface;
